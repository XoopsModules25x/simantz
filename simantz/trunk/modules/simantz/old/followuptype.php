...
include "class/FollowUpType.inc.php";
$followuptype = new FollowUpType();
$xoTheme->addScript('browse.php?Frameworks/jquery/jquery.js');
$followuptype->showSearchForm();
if($havewriteperm==1)
  ...
  <script language="javascript" type="text/javascript">
    jQuery(document).ready((function (){nitobi.loadComponent('DataboundGrid');}));
     ...
     function search(){
        ...
        var searchfollowuptype_name=document.getElementById("searchfollowuptype_name").value;
	...
	grid.getDataSource().setGetHandlerParameter('searchfollowuptype_name',searchfollowuptype_name);
...
<ntb:grid id="DataboundGrid"
     ...
     gethandler="load_data.php?action=followuptype&searchisactive=1"
     savehandler="save_data.php?action=followuptype"
     onbeforesaveevent="validateSave()"
     onaftersaveevent="savedone(eventArgs)"
     theme="$nitobigridthemes"
     rowsperpage="1">
   <ntb:columns>
       <ntb:textcolumn maxlength="30"  label="Follow Up Type Name"  xdatafld="followuptype_name" ></ntb:textcolumn>
