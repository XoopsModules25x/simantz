...
if($havewriteperm==1){ //user with write permission can edit grid, have button
 ...
 echo <<< EOF
  ...
  <script language="javascript" type="text/javascript">
	...
	grid.getDataSource().setGetHandlerParameter('searchindustry_name',searchindustry_name);
   ...
   function dataready(){
    ...
    if(document.getElementById("searchisdeleted").checked==true){// if in the show deleted, will go to normal page first.
       document.getElementById("searchisdeleted").checked=false;
       search();
     }
...
<ntb:grid id="DataboundGrid"
 ...
 <ntb:columns>
   ...
   <ntb:textcolumn  classname="{\$rh}" width="120" label="Industry Name" xdatafld="industry_name" ></ntb:textcolumn>


   <ntb:textcolumn classname="{\$rh}" label="Active" width="55" xdatafld="isactive" sortenabled="false">
   ...
   <ntb:numbercolumn classname="{\$rh}" maxlength="5" label="Seq No"  width="55" xdatafld="defaultlevel" mask="###0"></ntb:numbercolumn>
EOF;
//only admin user will see record info and isdeleted column
if($isadmin==1)
{
echo<<< EOF
<ntb:textcolumn  classname="{\$rh}" label="Log"   xdatafld="info"    width="25"  sortenabled="false" >
            <ntb:linkeditor></ntb:linkeditor openwindow="true" >
       </ntb:textcolumn>
       <ntb:textcolumn  classname="{\$rh}" label="Deleted"   width="50"  xdatafld="isdeleted">
...
EOF;
 ...
 echo <<< EOF
      <ntb:numbercolumn   label="ID"  width="0" xdatafld="industry_id" mask="###0" sortenabled="false">
                    </ntb:numbercolumn>
