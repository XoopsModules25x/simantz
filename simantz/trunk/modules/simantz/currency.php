  ...
  <script language="javascript" type="text/javascript">
   ...
   function save()
     ...
     if(validateEmpty()){
      ...
      document.getElementById('msgbox').innerHTML="<b style=\"color:red\">Currency code ,currency name or and country cannot be null</b><br/>";
...
//after insert a new line will automatically fill in some value here
  function setDefaultValue(eventArgs)
   ...
   function validateEmpty(){
        ...
        var countrycell = grid.getCellObject( i, 2);//1st para : row , 2nd para : column seq

           name = namecell.getValue();
           no = nocell.getValue();
           country = countrycell.getValue();
           if(name=="" || no=="" || country=="")
           {
            isallow = false;
           }
...
EOF;
 ...
 echo <<< EOF
      <ntb:numbercolumn   label="ID" visible="false" width="0" xdatafld="currency_id" mask="###0" sortenabled="false"></ntb:numbercolumn>
