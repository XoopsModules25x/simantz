 ...
 echo <<< EOF
  ...
  <script language="javascript" type="text/javascript">
    ...
    function GetNewRecordID()
    {
        ...
        //      myAjaxRequest.handler = 'getMaxID.php?idname=period_id&tablename=sim_simedu_period';
...
<ntb:grid id="DataboundGrid"
 ...
 <ntb:columns>
   <ntb:textcolumn width="210" label="Period Name" xdatafld="period_name"  classname="{\$rh}"></ntb:textcolumn>
   <ntb:textcolumn  $changewidth label="Month" xdatafld="period_month" classname="{\$rh}" ></ntb:textcolumn>
   <ntb:textcolumn  width="85" label="Year" xdatafld="period_year"  classname="{\$rh}" ></ntb:textcolumn>
...
EOF;
 ...
 echo <<< EOF
      <ntb:numbercolumn   label="ID"  width="0" xdatafld="period_id" mask="###0" sortenabled="false"></ntb:numbercolumn>
