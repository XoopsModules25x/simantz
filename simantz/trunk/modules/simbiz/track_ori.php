  ...
  <script language="javascript" type="text/javascript">
    ...
    function init(){}
     ...
     function search(){
        ...
        var searchtrack_description=document.getElementById("searchtrack_description").value;
        var searchtrack_name=document.getElementById("searchtrack_name").value;
	...
	grid.getDataSource().setGetHandlerParameter('searchtrack_description',searchtrack_description);
	grid.getDataSource().setGetHandlerParameter('searchtrack_name',searchtrack_name);
    ...
    function GetNewRecordID()
    {
        ...
        //      myAjaxRequest.handler = 'getMaxID.php?idname=track_id&tablename=sim_simedu_track';
   ...
   function save()
     ...
     if(validateEmpty()){
      ...
      document.getElementById('msgbox').innerHTML="<b style=\"color:red\">Track code and track name cannot be null</b><br/>";
...
<ntb:grid id="DataboundGrid"
 ...
 <ntb:columns>
   <ntb:textcolumn  width="85" label="Track Code" xdatafld="track_description"  classname="{\$rh}" ></ntb:textcolumn>
   <ntb:textcolumn width="210" label="Track Name" xdatafld="track_name"  classname="{\$rh}"></ntb:textcolumn>
...
EOF;
 ...
 echo <<< EOF
      <ntb:numbercolumn   label="ID"  width="0" xdatafld="track_id" mask="###0" sortenabled="false"></ntb:numbercolumn>
