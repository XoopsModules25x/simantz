...
<script type="text/javascript">
    ...
    function placeholdercontrol(){
     ...
     function updateHierarchy(){
        var arr_fld=new Array("action");//name for POST
	var arr_val=new Array("updateHierarchy");//value for POST
	getRequest(arr_fld,arr_val);}
</script>
...
/////////////
		...
		echo "<table><tr><td>";
		$o->showAccountsTree("AND accounts_id>0 and organization_id=$defaultorganization_id",
...
//		$trans->reverseSummary($bacthid);
 ...
 case "addchild" :
       $o->parentaccounts_id= $_GET['parentaccounts_id'];
	...
	$o->accountgroupctrl=$ctrl->getSelectAccountGroup($_GET['accountgroup_id'],'Y');
