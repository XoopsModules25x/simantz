...
$this->SetXY(12,10);
    ...
    $this->Cell(35,5,$this->period,1,0,'C');
    //$this->SetFont('Arial','',10);
    //$this->Cell(25,5,"Period",1,0,'C');
    //$this->SetFont('Arial','B',10);
    //$this->Cell(35,5,$this->period,1,0,'C');
	...
	$i=0;
	$header=array("No","Period", "Employee No.","Employee Name","EPF ($this->cur_symbol)","SOCSO ($this->cur_symbol)","Net Pay($this->cur_symbol)");

    	$w=array(10,30,30,85,40,40,40);
 ...
 */
	...
	$totalnet += $netpayamt;
        $totalepf += $employee_epfamt;
        $totalsocso += $employee_socsoamt;

//	$k=0;
//	while($k < 20){
//	$k++;
   	$data[]=array($i,$period_name,$employee_no,$employee_name,$employee_epfamt,$employee_socsoamt,$netpayamt);
//	}

	}
	$data[]=array("","","","Total",number_format($totalepf,2),number_format($totalsocso,2),number_format($totalnet,2));
...
<form name="frmSearchPayslip" action="viewpayrollsummary.php" method="POST" target="_blank">
