...
//	else
	...
	while($row=$xoopsDB->fetchArray($query)){
		...
		$transactionamt1=$row['transactionamt1'];
                ...
                $transactionamt1=$acc->getAccountDateRangeValue($datefrom1,$dateto1,$accounts_id,0);
                $transactionamt2=$acc->getAccountDateRangeValue($datefrom2,$dateto2,$accounts_id,0);
                }
