...
<ntb:grid id="DataboundGrid"
     ...
     gethandler="terms.php?action=search"
     savehandler="terms.php?action=save"
 ...
 <ntb:columns>
   ...
   <ntb:textcolumn  classname="{\$rh}" width="240" label="Terms Name" xdatafld="terms_name" ></ntb:textcolumn>

   <ntb:numbercolumn  classname="{\$rh}" width="80" label="Due Day" xdatafld="daycount" mask="###0"></ntb:numbercolumn>
...
EOF;
 ...
 echo <<< EOF
      <ntb:numbercolumn   label="ID"  width="0" visible="false" xdatafld="terms_id" mask="###0" sortenabled="false">
                    </ntb:numbercolumn>
