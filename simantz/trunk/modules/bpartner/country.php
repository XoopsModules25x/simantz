...
<ntb:grid id="DataboundGrid"
 ...
 <ntb:columns>
   <ntb:textcolumn  width="85" label="Country Code" xdatafld="country_code"  classname="{\$rh}" ></ntb:textcolumn>
   <ntb:textcolumn width="210" label="Country Name" xdatafld="country_name"  classname="{\$rh}"></ntb:textcolumn>
