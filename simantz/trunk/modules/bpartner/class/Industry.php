...
<table id='centercontainer' class="searchformblock" style="width:943px;">
 <tr><td nowrap>
    ...
    <div align="center" class="searchformheader">Search Industry</div>
			...
			<input name="searchindustry_name" id="searchindustry_name"></div>
...
EOF;
  ...
  public function showIndustry($wherestring){
    ...
    if(empty($pagesize)){
        ...
        if(empty($sortcolumn)){
           $sortcolumn="seqno, industry_name";
        }
...
if ($insertCount > 0)
{
      $arrfield=array("industry_name","isactive","seqno","created","createdby","updated","updatedby","organization_id","description");
