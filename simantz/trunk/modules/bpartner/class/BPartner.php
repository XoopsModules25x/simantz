 ...
 action="bpartner.php" name="frmBPartner"><table style="width:140px;"><tbody><td><input name="reset" value="Reset" type="reset"></td></tbody></table>
  ...
  <table style="text-align: left; width: 100%;" border="1" cellpadding="0" cellspacing="1">
	...
	&nbsp;Active <input type="checkbox" $checked name="isactive"> Default Level $mandatorysign <input maxlength="3" size="3" name='defaultlevel' value='$this->defaultlevel'>
        ...
        <td class="even" ><input maxlength="70" size="50" name="bpartner_name" value="$this->bpartner_name">
		</td>
      </tr>
     ...
     <tr>
        ...
        <td class="even" colspan="3"><select name="currency_id">$this->currencyctrl</select > $this->pricelistctrl</td>
      </tr>
      ...
      <tr>
	    ...
	    <td class="even" colspan='3'>
                ...
                Short Description <input name="shortremarks" value="$this->shortremarks">
...
EOF;
  ...
  public function updateBPartner( ) {
	...
	shortremarks='$this->shortremarks',
  ...
  public function insertBPartner( ) {
   ...
   $timestamp= date("y/m/d H:i:s", time()) ;
	$this->log->showLog(3,"Inserting new bpartner $this->bpartner_name");
  	$sql="INSERT INTO $this->tablebpartner (
	bpartnergroup_id,
	bpartner_no,
	bpartner_name,
	isactive,
	...
	istransporter,
	purchasecreditlimit,
	enforcesalescreditlimit,
	enforcepurchasecreditlimit,
	currentsalescreditstatus,
	currentpurchasecreditstatus,
	bankaccountname,
	bankname,
	bankaccountno,
	isdealer,
	...
	$this->currency_id,
	$this->terms_id,
	$this->salescreditlimit,
	$this->organization_id,
	'$this->bpartner_url',
	$this->debtoraccounts_id,
	'$this->description',
	0,
	$this->creditoraccounts_id,
	$this->isdebtor,
	$this->iscreditor,
	$this->istransporter,
	$this->purchasecreditlimit,
	$this->enforcesalescreditlimit,
	$this->enforcepurchasecreditlimit,
	$this->currentsalescreditstatus,
	$this->currentpurchasecreditstatus,
    ...
    $this->employee_id,'$this->shortremarks'
	)";
$this->updatesql=$sql;
	$this->log->showLog(4,"Before insert bpartner SQL:$sql");
	$rs=$this->xoopsDB->query($sql);
	
	if (!$rs){
		$this->log->showLog(1,"Failed to insert bpartner code $bpartner_name:" . mysql_error() . ":$sql");
		return false;
	}
	else{
		$this->log->showLog(3,"Inserting new bpartner $bpartner_name successfully"); 
		return true;
	}
