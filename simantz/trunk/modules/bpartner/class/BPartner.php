      ...
      while ($row=$xoopsDB->fetchArray($query))
     {
          if($rh=="even")
            ...
            if($currentRecord > $ordinalStart){
             ...
             $getHandler->DefineRecordFieldValue("info","recordinfo.php?id=".$row['contacts_id']."&tablename=sim_contacts&idname=contacts_id&title=Contacts");
      ...
      while ($row=$xoopsDB->fetchArray($query))
     {
          if($rh=="even")
            ...
            if($currentRecord > $ordinalStart){
             ...
             $getHandler->DefineRecordFieldValue("isactive", $row['isactive']);
             $getHandler->DefineRecordFieldValue("description",$row['description']);
             $getHandler->DefineRecordFieldValue("info","recordinfo.php?id=".$row['address_id']."&tablename=sim_address&idname=address_id&title=Business Address");
             $getHandler->DefineRecordFieldValue("address_id",$row['address_id']);
             $getHandler->DefineRecordFieldValue("rh",$rh);
             $getHandler->SaveRecord();
             }
