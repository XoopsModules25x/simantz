...
case "search": //return xml table to grid
    ...
    $o->showBPartnerList($wherestring);
...
//    search();
	...
	grid.getDataSource().setGetHandlerParameter('searchchar',var1);
   ...
   function save()
     {
      ...
      document.getElementById('msgbox').innerHTML="<a class=\"statusmsg\">Please enter Terms name</a><br/>";
...
<tr><td align="left"><form action="bpartner.php" method="POST"><input value="New" type="submit"></form></td></tr>
...
<ntb:grid id="DataboundGrid"
     ...
     gethandler="index.php?action=search&searchisactive=1"
 ...
 <ntb:columns>
   ...
   <ntb:numbercolumn  classname="{\$rh}" width="30" label="No" xdatafld="no" mask="###0"></ntb:numbercolumn>

   <ntb:textcolumn classname="{\$rh}" width="110" label="Business Partner No" xdatafld="bpartner_no" ></ntb:textcolumn>

   <ntb:textcolumn classname="{\$rh}" width="290" label="Business Partner Name" xdatafld="bpartner_name" ></ntb:textcolumn>

   <ntb:textcolumn classname="{\$rh}" width="150" label="Business Partner Group" xdatafld="bpartnergroup_name" ></ntb:textcolumn>
...
{
echo<<< EOF
   <ntb:textcolumn  label="Edit"   xdatafld="edit"    width="40"  sortenabled="false" classname="{\$rh}" oncellclickevent="javascript:editbpartner()">
