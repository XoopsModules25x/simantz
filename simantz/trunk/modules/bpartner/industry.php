   ...
   function save()
     {
      ...
      document.getElementById('msgbox').innerHTML="<b style=\"color:red\">Industry name cannot be null</b><br/>";
   ...
   myGrid.selectCellByCoords(rowNo, 0);
    ...
    function validateEmpty(){
     ...
     function resetsearch(){
      document.getElementById("searchindustry_name").value="";
...
<ntb:grid id="DataboundGrid"
 ...
 <ntb:columns>
   ...
   <ntb:textcolumn  classname="{\$rh}" width="240" label="Industry Name" xdatafld="industry_name" ></ntb:textcolumn>
...
EOF;
 ...
 echo <<< EOF
      <ntb:numbercolumn   label="ID"  width="0" visible="false" xdatafld="industry_id" mask="###0" sortenabled="false">
                    </ntb:numbercolumn>
