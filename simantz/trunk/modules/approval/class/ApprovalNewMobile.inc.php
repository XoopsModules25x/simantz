...
//constructor
   ...
   public function getApprovalList(){
        ...
        $html .= '<form name="'.$nameForm.'" id="'.$idForm.'" method="POST" action="newmobile.php#approvalList">';
...
echo <<< EOF
        ...
        <form id='idHistory1' method='post' action='newmobile.php#historyLeaveDetail'>
        <input type='hidden' name='day' value='1'>
        <input type='hidden' name='action' value='history'>
        </form>
        <form id='idHistory7' method='post' action='newmobile.php#historyLeaveDetail'>
        <input type='hidden' name='day' value='7'>
        <input type='hidden' name='action' value='history'>
        </form>
        <form id='idHistory30' method='post' action='newmobile.php#historyLeaveDetail'>
