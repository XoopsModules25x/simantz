<?php /* Smarty version 2.6.26, created on 2010-08-05 13:16:37
         compiled from /var/www/simantz/simantz/trunk/modules/system/class/gui/oxygen/xotpl/xo_metas.html */ ?>
...
<!-- Rss -->
<link rel="alternate" type="application/rss+xml" title="" href="<?php echo 'http://localhost/simantz/simantz/trunk/backend.php'; ?>" />

<!-- path favicon -->
<link rel="shortcut icon" type="image/ico" href="<?php echo 'http://localhost/simantz/simantz/trunk/favicon.ico'; ?>" />

<!-- Xoops style sheet -->
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo 'http://localhost/simantz/simantz/trunk/xoops.css'; ?>" />
