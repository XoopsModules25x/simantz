<?php /* Smarty version 2.6.26, created on 2010-08-05 13:16:37
         compiled from /var/www/simantz/simantz/trunk/modules/system/class/gui/oxygen/xotpl/xo_menu.html */ ?>
<div id="navbarCP">
    <!-- start menu -->
...
/index.html?style=dark"  rel="dark"  class="styleswitch"><?php echo @_MD_LANG_DARK; ?>
</a>
        <a href="<?php echo $this->_tpl_vars['theme_css']; ?>
/index.html?style=silver" rel="silver" class="styleswitch"><?php echo @_MD_LANG_SILVER; ?>
</a>
        <a href="<?php echo $this->_tpl_vars['theme_css']; ?>
/index.html?style=orange" rel="orange" class="styleswitch"><?php echo @_MD_LANG_ORANGE; ?>
</a>
    </div>
</div>
