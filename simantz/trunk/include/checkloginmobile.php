...
if ($uname == '' || $pass == '') {
    //redirect_header(XOOPS_URL . '/mobile/index.php', 1, _US_INCORRECTLOGIN,true,true);
    $url = XOOPS_URL ."/modules/approval/login.php?error=1";
echo <<< EOF
...
$lh = new LoginHistory();
$lh->insertEventRecord($user->getVar("uid"),"I","r");// (uid,insert,killprevioussession/reserveprevioussession)
//end modifcation kstan@simit.com.my 2009-06-23
    ...
    $url = XOOPS_URL ."/modules/approval/index.php#mainMenuPage";
echo <<< EOF
   <script type="text/javascript">
   self.location = "$url";
   </script>
...
EOF;
    ...
    //redirect_header(XOOPS_URL . '/mobile/index.php' , 5, $xoopsAuth->getHtmlErrors(), false);
