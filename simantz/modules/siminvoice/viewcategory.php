...
//-------------------------
	 $this->SetXY(89,30);
    $this->Cell(0,17,"Category List",0,0,'L');
	 $this->SetX(90);
...
//	 $this->SetXY(67,4);
    ...
    $this->Ln(18);
	 ...
	 $i=0;
	$header=array('No','Category No','Category Description','Category Type',"Active");
...
/*
	...
	$data[]=array($i,$row['category_code'],$row['category_desc'],$category_type,$isactive);
