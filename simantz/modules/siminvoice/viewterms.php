...
//-------------------------
	 $this->SetXY(89,30);
    $this->Cell(0,17,"Terms List",0,0,'L');
	 $this->SetX(90);
...
//	 $this->SetXY(67,4);
    ...
    $this->Ln(18);
	 ...
	 $i=0;
	$header=array('No','Terms No','Terms Description','Terms Days',"Active");
...
if ($_POST){
  /*
	...
	*/
	...
	$data[]=array($i,$row['terms_code'],$row['terms_desc'],$row['terms_days'],$isactive);
