...
<table border='1'>
	...
	<tr><td class='head'>Races</td><td class='odd'>$racesctrl </td>
			<td class='head'>Religion</td><td class='odd'>$religionctrl</td>
		</tr>
	<tr><td class='head'>HP</td><td class='odd'><input name='hpno'  value='$hpno'></td>
		<td class='head'>Region</td><td class='odd'>$regionctrl</td>
		</tr>
		<tr><td>
		<tr><td>
...
echo <<< EOF
    <tr>
        ...
        <td align='center'><a href='bpartner.php?action=view&bpartner_id=$bpartner_id'>$bpartner_name</a></td>
