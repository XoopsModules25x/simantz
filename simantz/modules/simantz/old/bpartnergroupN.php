...
<ntb:grid id="DataboundGrid"
     ...
     gethandler="load_data.php?action=bpartnergroup&searchisactive=1"
     savehandler="save_data.php?action=bpartnergroup"
     onbeforesaveevent="validateSave()"
     onaftersaveevent="savedone(eventArgs)"
     theme="$nitobithemes"
     rowsperpage="1">
   <ntb:columns>
       <ntb:textcolumn maxlength="30"  label="BPartner Group Name"  xdatafld="bpartnergroup_name" ></ntb:textcolumn>
       <ntb:numbercolumn   maxlength="4" label="Debtor Account"  width="100" xdatafld="debtoraccounts_id"></ntb:numbercolumn>
       <ntb:numbercolumn   maxlength="4" label="Creditor Account"  width="100" xdatafld="creditoraccounts_id"></ntb:numbercolumn>
