...
//$mcontent = implode("", $permission->window_dialog["Master Data"]);
//$tcontent = implode("", $permission->window_dialog["Transaction"]);
//$rcontent = implode("", $permission->window_dialog["Report"]);
 //var_dump($permission->window_dialog);

//echo <<< EOF
//    <div id="gmenu_content_master" class="gmenu_drop_content">$mcontent</div>
//    <div id="gmenu_content_transaction" class="gmenu_drop_content">$tcontent</div>
//    <div id="gmenu_content_report" class="gmenu_drop_content">$rcontent</div>
//EOF;
...
/*
  ...
  <div style="float:right; v-align:bottom; padding-left:1em;color: #4D2222;">User: $uname</div><div style="float:right; text-align:right; v-align:bottom;color: #4D2222;"> <img src='../simantz/images/user.png'/> $orgctrl</div>
  <br>

  EOF; */
//$url = XOOPS_URL;
if($_SESSION['DBNAME']!='')
$currentmode="(Training Mode)";
if ($helpurl != "")
...
location.href=url+'?setSessionDate=Y&defaultDateSession='+value;
	...
	<div style='color: #4D4D4D; v-align:top; line-height:3em;'>
	   <div style='float:left;font-weight:bold;text-align:left;font-size:24px;'>$menuname  $currentmode</div>
           <div style='float:left;padding-left:1em;'> $alertmsg</div>
           <div style="float:right; v-align:top; padding-left:1em;color: #223a4d;"><img src='../simantz/images/user.png'/> <a href='$url/user.php'>$uname</a></div>
