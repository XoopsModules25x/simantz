...
function IsNumeric(sText)
{
  ...
  function getWindow(){
    ...
    if(document.forms['frmShowSearch'].mid.value != "0")
    {
      document.forms['frmShowSearch'].window_name.disabled = false;
      var mid = document.forms['frmShowSearch'].mid.value;
    ...
    {
      document.forms['frmShowSearch'].window_name.value = "0";
      document.forms['frmShowSearch'].window_name.disabled = true;
    }
  }
...
$o->wname=$_POST['window_name'];
$o->mid=$_POST['mid'];
$o->table_name=$_POST['window_name'];
$o->uid=$_POST['uid'];
...
$o->windowsctrl=$o->getSelectWindows($o->wname,$o->mid,'Y');
$o->modulectrl=$o->getSelectModule($o->mid,'Y');
...
//	$o->showSearchResult();
  ...
  default :
       ...
       // $o->windowsctrl=$o->getSelectWindows($mid,'Y');
	$o->showSearchForm();
	if($o->issearch=="Y")
	$o->showSearchResult();
  break;
