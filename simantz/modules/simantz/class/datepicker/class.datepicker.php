...
class datePicker
{
	...
	$this->selectableYearsRange = array(array(1950, 2020, 1));
	...
	//  $this->strippedPath = "/class/datepicker/";
     ...
     *  @return void
     */
    function show($controlID, $startMonth = "", $startYear = "", $startHour = "", $startMinute = "",$isjavascript="null")
    {
