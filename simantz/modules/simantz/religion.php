...
if($isadmin==1){
    $grIdColumn=5; //define primary key column index, it will set as readonly afterwards (count from 0)
  ...
  <script language="javascript" type="text/javascript">
    ...
    function init(){}
     ...
     function search(){
        ...
        var searchreligion_description=document.getElementById("searchreligion_description").value;
        var searchreligion_name=document.getElementById("searchreligion_name").value;
	...
	grid.getDataSource().setGetHandlerParameter('searchreligion_description',searchreligion_description);
	grid.getDataSource().setGetHandlerParameter('searchreligion_name',searchreligion_name);
   ...
   function save()
     {
      ...
      document.getElementById('msgbox').innerHTML="<b style=\"color:red\">Religion code and religion name cannot be null</b><br/>";
...
<ntb:grid id="DataboundGrid"
     ...
     gethandler="religion.php?action=search"
     savehandler="religion.php?action=save"
 ...
 <ntb:columns>
   <ntb:textcolumn  width="100" label="Religion Code" xdatafld="religion_description"  classname="{\$rh}" ></ntb:textcolumn>
   <ntb:textcolumn width="210" label="Religion Name" xdatafld="religion_name"  classname="{\$rh}"></ntb:textcolumn>
...
EOF;
 ...
 echo <<< EOF
      <ntb:numbercolumn   label="ID" visible="false" width="0" xdatafld="religion_id" mask="###0" sortenabled="false"></ntb:numbercolumn>
