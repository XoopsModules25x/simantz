...
class SearchLayer{
	...
	public function SearchLayer(){
		...
		public function ctrlBPartner($arrfieldid,$arrfieldname,$arrvalue,$col=1,$changefunction,$bpartneraccounttype){
			...
			<input id='$field2_id' name='$field2_name' value='$value2' class='autocomplete' autocompleteurl='../bpartner/searchlayer.php?action=bpautocomp' size='8' $field2readonly>
			<input id='$field3_id' name='$field3_name' value='$value3' class='autocomplete' autocompleteurl='../bpartner/searchlayer.php?action=bpautocomp' size='25' $field3readonly>
