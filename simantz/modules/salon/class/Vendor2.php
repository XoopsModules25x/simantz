...
class Vendor
{
  ...
  public function insertVendor( ) {
	...
	$sql =	"INSERT INTO $this->tablevendor 	(vendor_no,vendor_name,vendor_hpno,
							vendor_telno,vendor_faxno,vendor_street1,vendor_street2,vendor_country,vendor_state,
...
<table style="width:140px;"><tbody><td>$addnewctrl</td><td><form onsubmit="return validateVendor()" method="post"
 ...
 <table cellspacing='3' border='1'>
    ...
    <tr>
      ...
      <td class="odd"><input name="vendor_no" value="$this->vendor_no" maxlength='10' size='10'></td>
      <td class="head">Vendor Name</td>
      <td class="odd"><input name="vendor_name" value="$this->vendor_name"  maxlength='100' size='60'></td>
    </tr>
  <tbody>
    ...
    <tr>
		...
		<td class="even"><input name="vendor_faxno"  maxlength="20" size="20"  value="$this->vendor_faxno" ></td>
		<td class="head">Street 1</td>
      		<td class="odd"><input name="vendor_street1" maxlength="100" size="35" value="$this->vendor_street1" ></td>
    </tr>
	...
	<tr>
	 ...
	 <tr>	
		...
		<td class="odd" acolspan="3"><input type="checkbox" $checked name="isactive" ></td>
...
public function getSelectVendor($id,$isitem='NY',$calledfunction="") {
  ...
  public function searchAToZ(){
	...
	echo "<b>Vnedor Grouping By Name: </b><br>";
	while ($row=$this->xoopsDB->fetchArray($query)){
