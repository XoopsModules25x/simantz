...
This file was generated on Fri Mar 21 2008 at 15:29:09
The original location of this file is /home/kstan/data/business/project/vision/code/Address.php
**************************************************************************/
...
class Address
{
 ...
 public function Address($xoopsDB,$tableprefix,$log){
	...
	$this->tablestudentclass=$tableprefix."simsalon_studentclass";
...
<table style="width:140px;"><tbody><td>$addnewctrl</td><td><form method="post" action="address.php" name="frmAddress" onSubmit="return validateAddress()"><input name="reset" value="Reset" type="reset"></td></tbody></table>
...
<tbody>
	...
	<tr>
			<td class="head">No.</td>
			<td class="odd"><input size="15" name="no" value="$this->no"></td>
			<td class="head">Street Name</td>
			<td class="odd"><input size="40" name="street1" value="$this->street1"></td>
	</tr>
	<tr>
		<td class="head">Taman / Garden</td>
		<td  class="even"><input size="40" name="street2" value="$this->street2"></td>
		<td class="head">Area Group</td>
		<td  class="even">$areactrl * Compulsory Field</td>
	</tr>
	<tr>
  ...
  public function createBlankAddress( $uid) {
	...
	$this->log->showLog(3,"Creating blank address, either for employee or organization, from uid: $uid");
   	$sql="INSERT INTO $this->tableaddress (updatedby,student_id,isactive,".
		"organization_id,created,createdby,updated,area_id) values ($uid,0,'Y',0,'$timestamp',$uid,'$timestamp',1);";
