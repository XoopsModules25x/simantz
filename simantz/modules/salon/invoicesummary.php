...
include_once 'class/Invoicesummary.php';
...
$dp->dateFormat='Y-m-d';
$log = new Log();
$o = new Invoicesummary($xoopsDB,$tableprefix,$log);
...
echo <<< EOF
<div style="border: 1px solid rgb(153, 153, 255); color: rgb(0, 0, 153);"><big><big><big><span style="font-weight: bold;">Invoice Summary Report</span></big></big></big></div><br>
...
$o->endctrl=$dp->show("end_date");
 ...
 switch ($action){
  ...
  default :
	...
	$o->vendorctrl=$v->getSelectVendor(0);
	$o->showInvoicesummaryTable();
  break;
