...
include_once 'class/Profitnloss.php';
...
$dp->dateFormat='Y-m-d';
$log = new Log();
$o = new Profitnloss($xoopsDB,$tableprefix,$log);
...
echo <<< EOF
<div style="border: 1px solid rgb(153, 153, 255); color: rgb(0, 0, 153);"><big><big><big><span style="font-weight: bold;">Profit & Loss Report</span></big></big></big></div><br>
