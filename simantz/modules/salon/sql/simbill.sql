...
-- 
-- Host: localhost
-- Generation Time: Apr 15, 2008 at 02:27 AM
...
CREATE TABLE IF NOT EXISTS `mega_avatar` (
...
CREATE TABLE IF NOT EXISTS `mega_avatar_user_link` (
...
CREATE TABLE IF NOT EXISTS `mega_banner` (
...
INSERT INTO `mega_banner` (`bid`, `cid`, `imptotal`, `impmade`, `clicks`, `imageurl`, `clickurl`, `date`, `htmlbanner`, `htmlcode`) VALUES 
(1, 1, 0, 1, 0, 'http://localhost/simbill/images/banners/xoops_banner.gif', 'http://www.xoops.org/', 1008813250, 0, ''),
(2, 1, 0, 1, 0, 'http://localhost/simbill/images/banners/xoops_banner_2.gif', 'http://www.xoops.org/', 1008813250, 0, ''),
(3, 1, 0, 1, 0, 'http://localhost/simbill/images/banners/banner.swf', 'http://www.xoops.org/', 1008813250, 0, '');
...
CREATE TABLE IF NOT EXISTS `mega_bannerclient` (
...
INSERT INTO `mega_bannerclient` (`cid`, `name`, `contact`, `email`, `login`, `passwd`, `extrainfo`) VALUES 
...
CREATE TABLE IF NOT EXISTS `mega_bannerfinish` (
  `bid` smallint(5) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `mega_block_module_link` (
...
INSERT INTO `mega_block_module_link` (`block_id`, `module_id`) VALUES 
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
CREATE TABLE IF NOT EXISTS `mega_config` (
...
INSERT INTO `mega_config` (`conf_id`, `conf_modid`, `conf_catid`, `conf_name`, `conf_title`, `conf_value`, `conf_desc`, `conf_formtype`, `conf_valuetype`, `conf_order`) VALUES 
...
(39, 0, 3, 'footer', '_MD_AM_FOOTER', 'Powered by XOOPS 2.0 &copy; 2001-2008 <a href="http://xoops.sourceforge.net/" target="_blank">The XOOPS Project</a>', '_MD_AM_FOOTERDSC', 'textarea', 'text', 20),
...
(50, 0, 3, 'meta_copyright', '_MD_AM_METACOPYR', 'Copyright &copy; 2001-2008', '_MD_AM_METACOPYRDSC', 'textbox', 'text', 8),
...
CREATE TABLE IF NOT EXISTS `mega_configcategory` (
...
INSERT INTO `mega_configcategory` (`confcat_id`, `confcat_name`, `confcat_order`) VALUES 
(1, '_MD_AM_GENERAL', 0),
...
CREATE TABLE IF NOT EXISTS `mega_configoption` (
...
INSERT INTO `mega_configoption` (`confop_id`, `confop_name`, `confop_value`, `conf_id`) VALUES 
...
INSERT INTO `mega_groups` (`groupid`, `name`, `description`, `group_type`) VALUES 
...
CREATE TABLE IF NOT EXISTS `mega_groups_users_link` (
...
INSERT INTO `mega_groups_users_link` (`linkid`, `groupid`, `uid`) VALUES 
(1, 1, 1),
(2, 2, 1);
...
CREATE TABLE IF NOT EXISTS `mega_group_permission` (
...
INSERT INTO `mega_group_permission` (`gperm_id`, `gperm_groupid`, `gperm_itemid`, `gperm_modid`, `gperm_name`) VALUES 
...
CREATE TABLE IF NOT EXISTS `mega_image` (
...
CREATE TABLE IF NOT EXISTS `mega_imagebody` (
...
CREATE TABLE IF NOT EXISTS `mega_imagecategory` (
...
CREATE TABLE IF NOT EXISTS `mega_imgset` (
...
INSERT INTO `mega_imgset` (`imgset_id`, `imgset_name`, `imgset_refid`) VALUES 
(1, 'default', 0);
...
CREATE TABLE IF NOT EXISTS `mega_imgsetimg` (
...
CREATE TABLE IF NOT EXISTS `mega_imgset_tplset_link` (
...
INSERT INTO `mega_imgset_tplset_link` (`imgset_id`, `tplset_name`) VALUES 
(1, 'default');
...
CREATE TABLE IF NOT EXISTS `mega_modules` (
...
INSERT INTO `mega_modules` (`mid`, `name`, `version`, `last_update`, `weight`, `isactive`, `dirname`, `hasmain`, `hasadmin`, `hassearch`, `hasconfig`, `hascomments`, `hasnotification`) VALUES 
(1, 'System', 102, 1208196917, 0, 1, 'system', 0, 1, 0, 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `mega_newblocks` (
...
INSERT INTO `mega_newblocks` (`bid`, `mid`, `func_num`, `options`, `name`, `title`, `content`, `side`, `weight`, `visible`, `block_type`, `c_type`, `isactive`, `dirname`, `func_file`, `show_func`, `edit_func`, `template`, `bcachetime`, `last_modified`) VALUES 
(1, 1, 1, '', 'User Menu', 'User Menu', '', 0, 0, 1, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_user_show', '', 'system_block_user.html', 0, 1208196917),
(2, 1, 2, '', 'Login', 'Login', '', 0, 0, 1, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_login_show', '', 'system_block_login.html', 0, 1208196917),
(3, 1, 3, '', 'Search', 'Search', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_search_show', '', 'system_block_search.html', 0, 1208196917),
(4, 1, 4, '', 'Waiting Contents', 'Waiting Contents', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_waiting_show', '', 'system_block_waiting.html', 0, 1208196917),
(5, 1, 5, '', 'Main Menu', 'Main Menu', '', 0, 0, 1, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_main_show', '', 'system_block_mainmenu.html', 0, 1208196917),
(6, 1, 6, '320|190|s_poweredby.gif|1', 'Site Info', 'Site Info', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_info_show', 'b_system_info_edit', 'system_block_siteinfo.html', 0, 1208196917),
(7, 1, 7, '', 'Who''s Online', 'Who''s Online', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_online_show', '', 'system_block_online.html', 0, 1208196917),
(8, 1, 8, '10|1', 'Top Posters', 'Top Posters', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_topposters_show', 'b_system_topposters_edit', 'system_block_topusers.html', 0, 1208196917),
(9, 1, 9, '10|1', 'New Members', 'New Members', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_newmembers_show', 'b_system_newmembers_edit', 'system_block_newusers.html', 0, 1208196917),
(10, 1, 10, '10', 'Recent Comments', 'Recent Comments', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_comments_show', 'b_system_comments_edit', 'system_block_comments.html', 0, 1208196917),
(11, 1, 11, '', 'Notification Options', 'Notification Options', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_notification_show', '', 'system_block_notification.html', 0, 1208196917),
(12, 1, 12, '0|80', 'Themes', 'Themes', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_themes_show', 'b_system_themes_edit', 'system_block_themes.html', 0, 1208196917);
...
CREATE TABLE IF NOT EXISTS `mega_online` (
...
CREATE TABLE IF NOT EXISTS `mega_priv_msgs` (
...
CREATE TABLE IF NOT EXISTS `mega_ranks` (
...
INSERT INTO `mega_ranks` (`rank_id`, `rank_title`, `rank_min`, `rank_max`, `rank_special`, `rank_image`) VALUES 
...
CREATE TABLE IF NOT EXISTS `mega_session` (
...
INSERT INTO `mega_session` (`sess_id`, `sess_updated`, `sess_ip`, `sess_data`) VALUES 
('66dc4ebbe47d5d0c759d599be9bc0c54', 1208197378, '127.0.0.1', 'xoopsUserId|s:1:"1";xoopsUserGroups|a:2:{i:0;s:1:"1";i:1;s:1:"2";}xoopsUserTheme|s:7:"default";XOOPS_TOKEN_SESSION|a:1:{i:0;a:2:{s:2:"id";s:32:"95dc2d7579ce92c0191a69f364384681";s:6:"expire";i:1208197836;}}');
...
CREATE TABLE IF NOT EXISTS `mega_smiles` (
...
INSERT INTO `mega_smiles` (`id`, `code`, `smile_url`, `emotion`, `display`) VALUES 
...
CREATE TABLE IF NOT EXISTS `mega_tplfile` (
...
INSERT INTO `mega_tplfile` (`tpl_id`, `tpl_refid`, `tpl_module`, `tpl_tplset`, `tpl_file`, `tpl_desc`, `tpl_lastmodified`, `tpl_lastimported`, `tpl_type`) VALUES 
(1, 1, 'system', 'default', 'system_imagemanager.html', '', 1208196917, 1208196917, 'module'),
(2, 1, 'system', 'default', 'system_imagemanager2.html', '', 1208196917, 1208196917, 'module'),
(3, 1, 'system', 'default', 'system_userinfo.html', '', 1208196917, 1208196917, 'module'),
(4, 1, 'system', 'default', 'system_userform.html', '', 1208196917, 1208196917, 'module'),
(5, 1, 'system', 'default', 'system_rss.html', '', 1208196917, 1208196917, 'module'),
(6, 1, 'system', 'default', 'system_redirect.html', '', 1208196917, 1208196917, 'module'),
(7, 1, 'system', 'default', 'system_comment.html', '', 1208196917, 1208196917, 'module'),
(8, 1, 'system', 'default', 'system_comments_flat.html', '', 1208196917, 1208196917, 'module'),
(9, 1, 'system', 'default', 'system_comments_thread.html', '', 1208196917, 1208196917, 'module'),
(10, 1, 'system', 'default', 'system_comments_nest.html', '', 1208196917, 1208196917, 'module'),
(11, 1, 'system', 'default', 'system_siteclosed.html', '', 1208196917, 1208196917, 'module'),
(12, 1, 'system', 'default', 'system_dummy.html', 'Dummy template file for holding non-template contents. This should not be edited.', 1208196917, 1208196917, 'module'),
(13, 1, 'system', 'default', 'system_notification_list.html', '', 1208196917, 1208196917, 'module'),
(14, 1, 'system', 'default', 'system_notification_select.html', '', 1208196917, 1208196917, 'module'),
(15, 1, 'system', 'default', 'system_block_dummy.html', 'Dummy template for custom blocks or blocks without templates', 1208196917, 1208196917, 'module'),
(16, 1, 'system', 'default', 'system_block_user.html', 'Shows user block', 1208196917, 1208196917, 'block'),
(17, 2, 'system', 'default', 'system_block_login.html', 'Shows login form', 1208196917, 1208196917, 'block'),
(18, 3, 'system', 'default', 'system_block_search.html', 'Shows search form block', 1208196917, 1208196917, 'block'),
(19, 4, 'system', 'default', 'system_block_waiting.html', 'Shows contents waiting for approval', 1208196917, 1208196917, 'block'),
(20, 5, 'system', 'default', 'system_block_mainmenu.html', 'Shows the main navigation menu of the site', 1208196917, 1208196917, 'block'),
(21, 6, 'system', 'default', 'system_block_siteinfo.html', 'Shows basic info about the site and a link to Recommend Us pop up window', 1208196917, 1208196917, 'block'),
(22, 7, 'system', 'default', 'system_block_online.html', 'Displays users/guests currently online', 1208196917, 1208196917, 'block'),
(23, 8, 'system', 'default', 'system_block_topusers.html', 'Top posters', 1208196917, 1208196917, 'block'),
(24, 9, 'system', 'default', 'system_block_newusers.html', 'Shows most recent users', 1208196917, 1208196917, 'block'),
(25, 10, 'system', 'default', 'system_block_comments.html', 'Shows most recent comments', 1208196917, 1208196917, 'block'),
(26, 11, 'system', 'default', 'system_block_notification.html', 'Shows notification options', 1208196917, 1208196917, 'block'),
(27, 12, 'system', 'default', 'system_block_themes.html', 'Shows theme selection box', 1208196917, 1208196917, 'block');
...
CREATE TABLE IF NOT EXISTS `mega_tplset` (
...
INSERT INTO `mega_tplset` (`tplset_id`, `tplset_name`, `tplset_desc`, `tplset_credits`, `tplset_created`) VALUES 
(1, 'default', 'XOOPS Default Template Set', '', 1208196917);
...
CREATE TABLE IF NOT EXISTS `mega_tplsource` (
...
INSERT INTO `mega_tplsource` (`tpl_id`, `tpl_source`) VALUES 
...
CREATE TABLE IF NOT EXISTS `mega_users` (
...
INSERT INTO `mega_users` (`uid`, `name`, `uname`, `email`, `url`, `user_avatar`, `user_regdate`, `user_icq`, `user_from`, `user_sig`, `user_viewemail`, `actkey`, `user_aim`, `user_yim`, `user_msnm`, `pass`, `posts`, `attachsig`, `rank`, `level`, `theme`, `timezone_offset`, `last_login`, `umode`, `uorder`, `notify_method`, `notify_mode`, `user_occ`, `bio`, `user_intrest`, `user_mailok`) VALUES 
(1, '', 'admin', 'admin@simit.com.my', 'http://localhost/simbill/', 'blank.gif', 1208196917, '', '', '', 1, '', '', '', '', '21232f297a57a5a743894a0e4a801fc3', 0, 0, 7, 5, 'default', 0.0, 1208196932, 'thread', 0, 1, 0, '', '', '', 0);
...
CREATE TABLE IF NOT EXISTS `mega_xoopscomments` (
...
CREATE TABLE IF NOT EXISTS `mega_xoopsnotifications` (
