...
function Header()
{
	...
	$this->Cell(0,4,"Customer Type Report",0,1,'L');
	...
	*/
	...
	$header =array("No","Customer","Type","IC No","H/P Contact","Gender","Join Date");
	$w=array(10,60,21,30,30,15,25); // total width = 285
...
if (true){
	...
	$wherestr .= " where a.joindate between '$start_date' and '$end_date' ";

	if($customertype > 0)
	$wherestr .= " and a.customertype = $customertype ";

	$wherestr .= " and a.customertype = b.customertype_id ";
	...
	$gender = "Female";
 	...
 	$data[]=array($i,$customer_name,$customertype,$ic_no,$hp_no,$gender,$joindate);
