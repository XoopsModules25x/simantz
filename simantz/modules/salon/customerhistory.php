...
include_once 'class/Customerhistory.php';
...
$dp->dateFormat='Y-m-d';
$log = new Log();
$o = new Customerhistory($xoopsDB,$tableprefix,$log);
...
echo <<< EOF
<div style="border: 1px solid rgb(153, 153, 255); color: rgb(0, 0, 153);"><big><big><big><span style="font-weight: bold;">Customer History Report</span></big></big></big></div><br>
...
$o->endctrl=$dp->show("end_date");
 ...
 switch ($action){
  ...
  default :
	...
	$o->customerctrl=$c->getSelectCustomer(0,"","customer_id");
	$o->showCustomerhistoryTable();
  break;
