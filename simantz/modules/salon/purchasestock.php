...
include_once 'class/Purchasestock.php';
...
$dp->dateFormat='Y-m-d';
$log = new Log();
$o = new Purchasestock($xoopsDB,$tableprefix,$log);
...
echo <<< EOF
<div style="border: 1px solid rgb(153, 153, 255); color: rgb(0, 0, 153);"><big><big><big><span style="font-weight: bold;">Stock Replenish 	 Report</span></big></big></big></div><br>
...
$o->endctrl=$dp->show("end_date");
 ...
 switch ($action){
  ...
  default :
	...
	$o->categoryctrl=$c->getSelectCategory(0,'','Y','N');
	$o->showPurchasestockTable();
  break;
