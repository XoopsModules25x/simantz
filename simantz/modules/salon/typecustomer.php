...
include_once 'class/Typecustomer.php';
...
$dp->dateFormat='Y-m-d';
$log = new Log();
$o = new Typecustomer($xoopsDB,$tableprefix,$log);
...
echo <<< EOF
<div style="border: 1px solid rgb(153, 153, 255); color: rgb(0, 0, 153);"><big><big><big><span style="font-weight: bold;">Customer Type Report</span></big></big></big></div><br>
