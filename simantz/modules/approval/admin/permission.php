...
<script type="text/javascript">
	...
	var itemcount=document.forms['frmUpdatePermission'].linecount.value;
		for(var i = 0; i < itemcount; i++)
			document.forms['frmUpdatePermission'].elements["isreadonly["+i+"]"].checked = true;
	}

	function removeallview(){
	var itemcount=document.forms['frmUpdatePermission'].linecount.value;
		for(var i = 0; i < itemcount; i++)
			document.forms['frmUpdatePermission'].elements["isreadonly["+i+"]"].checked = false;
	}
