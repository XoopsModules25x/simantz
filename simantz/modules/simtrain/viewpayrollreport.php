...
$this->SetXY(12,10);
    ...
    $this->Cell(0,17,"Payroll Summary Report",1,0,'R');
    $this->Ln(20);
...
if ($_POST){
	...
	$orderbystring = "order by p.payslipdate,e.employee_name";
...
<form name="frmSearchPayslip" action="viewpayrollreport.php" method="POST">
