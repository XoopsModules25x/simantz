...
//    $this->Cell(105,17," ",1,0,'R');
    ...
    while($this->GetStringWidth($this->description)> 92)
			$this->description=substr_replace($this->description,"",-1);
    $this->Cell(93,7,$this->description,1,0,'C');
    $this->SetFont('Times','',10);
   // $this->Cell(19,7,"Fees (RM)",1,0,'C');
   ...
   // $this->Cell(16,7,$this->amt,1,0,'C');
    ...
    $this->SetFont('Times','B',10);
    $this->Cell(22,7,$this->time,1,0,'C');
    $this->Ln(); 
    $this->SetFont('Times','',10);
    ...
    $this->SetFont('Times','',10);
    $this->Cell(35,7,"Tutor Contact",1,0,'C');
    $this->SetFont('Times','B',10);
    $this->Cell(22,7,$this->e_hp_no,1,0,'C');
    $this->SetFont('Times','',10);
    $this->Cell(16,7, "Place",1,0,'C');
    $this->SetFont('Times','B',10);
    $this->Cell(22,7, "$this->organization_code",1,0,'C');
...
$i=0;
   ...
   $w=array(6,14,54,35,13,6,6,6,6,6,6,27); //12 data
if($this->showRMK==""){
array_push($this->header,"Remark");
$this->showRMK="1";
}
...
//	$header=array('No','Code','Student Name', 'Contact No.', 'School', 'Fees', '1st', '2nd', '3rd', '4th', '5th', 'RMK');
	...
	$sql="SELECT s.student_id,s.student_code,s.alternate_name, s.student_name,concat(s.hp_no,'/', s.tel_1) as hp_no, sch.school_name, std.standard_name,x.amt, x.isactive, x.studentclass_id,x.description".
