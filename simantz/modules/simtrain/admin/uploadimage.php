...
move_uploaded_file($tmpfile1, "../upload/images/logobk.jpg");
...
move_uploaded_file($tmpfile2, "../upload/images/attlistlogo.jpg");
}
if($filesize3== 0 || $filesize3>1000)
echo "Image 3 $tmpfile3,$filesize3 error!<br>";
else{
echo "Image 3 $tmpfile3, $filesize3 ok!<br>";
move_uploaded_file($tmpfile3, "../upload/images/namecardbg.jpg");
}
...
move_uploaded_file($tmpfile4, "../upload/images/namecardbgback.jpg");
}
