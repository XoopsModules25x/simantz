...
<script type="text/javascript">
	function validateOrganization(){
		...
		if(confirm('Confirm save this record?'))
		if(name =="" || code==""){
	...
	function showAddressWindow(address_id){
		window.open('../address.php?address_id='+address_id+'&action=edit', "Editing address", "width=800,height=700,scrollbars=yes");
	}
</script>
...
$o->tel_2=$_POST["tel_2"];
$o->fax=$_POST["fax"];
$o->studentcard_info=$_POST['studentcard_info'];
$o->groupid=$_POST['groupid'];
$o->rob_no=$_POST['rob_no'];
$o->jpn_no=$_POST['jpn_no'];
