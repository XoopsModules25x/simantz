...
//constructor
  ...
  public function getInputForm( $type,  $religion_id,$token  ) {
    ...
    echo <<< EOF
<!--<div style="border: 1px solid rgb(153, 153, 255); color: rgb(0, 0, 153);"><big><big><big><span style="font-weight: bold;">Student Religion Master</span></big></big></big></div><br>-->
  ...
  <table style="text-align: left; width: 100%;" border="1" cellpadding="0" cellspacing="3">
    <tbody>
      <tr>
       ...
       <tr>
        <td class="head">Religion Name $mandatorysign<input type='hidden' value='0' name='organization_id'></td>
...
EOF;
  ...
  public function fetchReligion( $religion_id) {
	...
	$sql="SELECT religion_id,religion_name,religion_description,isactive,organization_id from $this->tablereligion ". 
  ...
  $this->log->showLog(4,"Running ProductReligion->getSQLStr_AllReligion: $sql");
    $sql="SELECT religion_name,religion_description,religion_id,isactive,organization_id FROM $this->tablereligion " .
