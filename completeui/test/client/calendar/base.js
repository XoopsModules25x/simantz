...
nitobi.testframework.baseDir = baseDir + window.location.pathname.substring(0,window.location.pathname.indexOf('test/'));
...
nitobi.testframework.includeCss = function(file)
{
...
function initTest(showDebugTools)
{
	...
	// JS Spec
	nitobi.testframework.includeJs(nitobi.testframework.testFrameworkBaseDir + "/jsspec/JSSpec.js");
	nitobi.testframework.includeJs(nitobi.testframework.testFrameworkBaseDir + "/jsspec/diff_match_patch.js");
	nitobi.testframework.includeCss(nitobi.testframework.testFrameworkBaseDir + "/jsspec/JSSpec.css");
